...
public class TitreHopEntity {
    ...
    @Temporal(TemporalType.DATE)
    @Column(name = "DebFact")
    private Date DebFact;

    @Temporal(TemporalType.DATE)
    @Column(name = "FinFact")
    private Date FinFact;
    ...
    @Column(name = "CodEtGeo")
    private String CodEtGeo;

    @Temporal(TemporalType.DATE)
    @Column(name = "DteMalade")
    private Date DteMalade;
